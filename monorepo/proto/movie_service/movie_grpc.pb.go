...
const (
	...
	MovieService_GetMovies_FullMethodName   = "/movie_service.MovieService/GetMovies"
	MovieService_GetMovie_FullMethodName    = "/movie_service.MovieService/GetMovie"
	MovieService_UpdateMovie_FullMethodName = "/movie_service.MovieService/UpdateMovie"
...
type MovieServiceClient interface {
	CreateMovie(ctx context.Context, in *Movie, opts ...grpc.CallOption) (*Empty, error)
	GetMovies(ctx context.Context, in *Pagination, opts ...grpc.CallOption) (*MovieList, error)
	GetMovie(ctx context.Context, in *MovieId, opts ...grpc.CallOption) (*Movie, error)
	UpdateMovie(ctx context.Context, in *Movie, opts ...grpc.CallOption) (*Empty, error)
...
func (c *movieServiceClient) CreateMovie(ctx context.Context, in *Movie, opts ...grpc.CallOption) (*Empty, error) {
...
func (c *movieServiceClient) GetMovies(ctx context.Context, in *Pagination, opts ...grpc.CallOption) (*MovieList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MovieList)
...
func (c *movieServiceClient) UpdateMovie(ctx context.Context, in *Movie, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type MovieServiceServer interface {
	CreateMovie(context.Context, *Movie) (*Empty, error)
	GetMovies(context.Context, *Pagination) (*MovieList, error)
	GetMovie(context.Context, *MovieId) (*Movie, error)
	UpdateMovie(context.Context, *Movie) (*Empty, error)
...
func (UnimplementedMovieServiceServer) CreateMovie(context.Context, *Movie) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateMovie not implemented")
}
func (UnimplementedMovieServiceServer) GetMovies(context.Context, *Pagination) (*MovieList, error) {
...
func (UnimplementedMovieServiceServer) UpdateMovie(context.Context, *Movie) (*Empty, error) {
...
func _MovieService_GetMovies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).GetMovies(ctx, req.(*Pagination))
	}
	return interceptor(ctx, in, info, handler)
}
